...
启动注意:
    如果没有 AWS 账号, 一定要 注释掉 com.deepblue.amazon 包中的代码! 否则起不来!


spring-batch JobLauncher, Job, Step [Reader, Processor, Writer]

schedule spring 原生定时任务

ExceptionHandler 全局异常处理器

Validator 自定义校验器

RRateLimiter RedissonClient 分桶限流
